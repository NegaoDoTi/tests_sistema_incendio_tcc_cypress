...
import usuarios from '../../cypress/fixtures/unregistered_users.json'

describe("Teste de login com dados não cadastrados", () => {

    it("Logando usuarios que nao foram cadastrados previamente", () => {
